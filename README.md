...
Provides shared utilities for selecting serial, parallel, or automatic execution, resolving the number of worker processes, and limiting BLAS/OpenMP numerical kernels to one thread per worker to reduce CPU oversubscription.
